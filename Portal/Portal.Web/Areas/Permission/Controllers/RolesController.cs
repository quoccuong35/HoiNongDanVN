    ...
    public class RolesController : BaseController
    {
       ...
       // [PortalAuthorizationAttribute]
        ...
        public List<Portal.Models.Page> GetMenuFunctions(Guid? id) {
            ...
            {
                Portal.Models.Page add = new Portal.Models.Page();
        ...
        public void SetMenuFunctionParent(List<Portal.Models.Page> list,List<MenuModel> Pages, MenuModel page, List<PageFunctionModel> pageFuncs, List<PagePermissionModel> pagePermis)
        {
        ...
        public List<PageFuntion> AddPageFunction(Portal.Models.Page add,List<PageFunctionModel> pageFuncs,List<PagePermissionModel>pagePermis) {
