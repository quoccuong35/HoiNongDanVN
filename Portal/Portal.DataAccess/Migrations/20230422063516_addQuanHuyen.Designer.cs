...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230422063516_addQuanHuyen")]
    partial class addQuanHuyen
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 13, 35, 16, 50, DateTimeKind.Local).AddTicks(7969));
            ...
            modelBuilder.Entity("Portal.Models.Entitys.MasterData.KhuVuc", b =>
                {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.MasterData.QuanHuyen", b =>
                {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.MasterData.TinhThanhPho", b =>
                {
                    b.Property<string>("MaTinhThanhPho")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 13, 35, 16, 51, DateTimeKind.Local).AddTicks(1140));
            ...
            modelBuilder.Entity("Portal.Models.Entitys.MasterData.QuanHuyen", b =>
                {
                    b.HasOne("Portal.Models.Entitys.MasterData.TinhThanhPho", "TinhThanhPho")
                        .WithMany("QuanHuyens")
            ...
            modelBuilder.Entity("Portal.Models.Entitys.MasterData.TinhThanhPho", b =>
                {
                    b.HasOne("Portal.Models.Entitys.MasterData.KhuVuc", "KhuVuc")
