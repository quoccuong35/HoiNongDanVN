...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230422044834_addKhuVuc")]
    partial class addKhuVuc
    {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 11, 48, 34, 210, DateTimeKind.Local).AddTicks(7590));
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 11, 48, 34, 212, DateTimeKind.Local).AddTicks(914));
