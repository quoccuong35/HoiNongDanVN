...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230504034050_addQuanHeGiaDinh")]
    partial class addQuanHeGiaDinh
    {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 10, 40, 49, 456, DateTimeKind.Local).AddTicks(8669));
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 10, 40, 49, 457, DateTimeKind.Local).AddTicks(3019));
