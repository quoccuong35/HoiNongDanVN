...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230423122302_editCanBo1")]
    partial class editCanBo1
    {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 23, 19, 23, 1, 643, DateTimeKind.Local).AddTicks(1351));
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 23, 19, 23, 1, 643, DateTimeKind.Local).AddTicks(5385));
