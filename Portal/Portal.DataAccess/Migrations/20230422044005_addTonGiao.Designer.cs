...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230422044005_addTonGiao")]
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 11, 40, 5, 162, DateTimeKind.Local).AddTicks(1779));
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 11, 40, 5, 162, DateTimeKind.Local).AddTicks(8372));
