...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230522134412_addMienNhiem")]
    partial class addMienNhiem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Models.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 22, 20, 44, 10, 659, DateTimeKind.Local).AddTicks(811));
            ...
            modelBuilder.Entity("Portal.Models.HinhThucDaoTao", b =>
                {
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 22, 20, 44, 10, 659, DateTimeKind.Local).AddTicks(5257));
            ...
            modelBuilder.Entity("Portal.Models.QuaTrinhBoiDuong", b =>
                {
            ...
            modelBuilder.Entity("Portal.Models.QuaTrinhCongTac", b =>
                {
            ...
            modelBuilder.Entity("Portal.Models.QuaTrinhMienNhiem", b =>
                {
            ...
            modelBuilder.Entity("Portal.Models.QuaTrinhBoiDuong", b =>
                {
                    ...
                    b.HasOne("Portal.Models.HinhThucDaoTao", "HinhThucDaoTao")
                        .WithMany("QuaTrinhBoiDuongs")
            ...
            modelBuilder.Entity("Portal.Models.QuaTrinhDaoTao", b =>
                {
                    ...
                    b.HasOne("Portal.Models.ChuyenNganh", "ChuyenNganh")
                        .WithMany("QuaTrinhDaoTaos")
                    ...
                    b.HasOne("Portal.Models.LoaiBangCap", "LoaiBangCap")
                        .WithMany("QuaTrinhDaoTaos")
