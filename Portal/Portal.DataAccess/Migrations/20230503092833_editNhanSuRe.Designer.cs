...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230503092833_editNhanSuRe")]
    partial class editNhanSuRe
    {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 3, 16, 28, 32, 492, DateTimeKind.Local).AddTicks(7306));
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 3, 16, 28, 32, 493, DateTimeKind.Local).AddTicks(1573));
