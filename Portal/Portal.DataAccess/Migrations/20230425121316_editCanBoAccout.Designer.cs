...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230425121316_editCanBoAccout")]
    partial class editCanBoAccout
    {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 25, 19, 13, 15, 42, DateTimeKind.Local).AddTicks(9589));
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 25, 19, 13, 15, 43, DateTimeKind.Local).AddTicks(3072));
