...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230422091701_addCanBo")]
    partial class addCanBo
    {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 16, 17, 0, 409, DateTimeKind.Local).AddTicks(2759));
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 16, 17, 0, 409, DateTimeKind.Local).AddTicks(7553));
