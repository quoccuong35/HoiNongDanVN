...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230422074930_addTinhTrang")]
    partial class addTinhTrang
    {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 14, 49, 29, 771, DateTimeKind.Local).AddTicks(8389));
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 14, 49, 29, 772, DateTimeKind.Local).AddTicks(2788));
