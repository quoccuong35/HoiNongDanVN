...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230420134929_addDB")]
    partial class addDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Models.Entitys.BacLuong", b =>
                {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 20, 20, 49, 29, 91, DateTimeKind.Local).AddTicks(8473));
            ...
            modelBuilder.Entity("Portal.Models.Entitys.NgachLuong", b =>
                {
                    b.Property<string>("MaNgachLuong")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 20, 20, 49, 29, 92, DateTimeKind.Local).AddTicks(1855));
            ...
            modelBuilder.Entity("Portal.Models.Entitys.ProjectModel", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 20, 20, 49, 29, 92, DateTimeKind.Local).AddTicks(5492));
            ...
            modelBuilder.Entity("Portal.Models.Entitys.BacLuong", b =>
                {
                    b.HasOne("Portal.Models.Entitys.NgachLuong", "NgachLuong")
                        .WithMany("BacLuongs")
