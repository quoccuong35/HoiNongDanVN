...
namespace Portal.DataAccess.Migrations
{
    ...
    [Migration("20230422062138_addTinhThanhKho")]
    partial class addTinhThanhKho
    {
            ...
            modelBuilder.Entity("Portal.Models.Entitys.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 13, 21, 38, 288, DateTimeKind.Local).AddTicks(8897));
            ...
            modelBuilder.Entity("Portal.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 22, 13, 21, 38, 289, DateTimeKind.Local).AddTicks(6894));
