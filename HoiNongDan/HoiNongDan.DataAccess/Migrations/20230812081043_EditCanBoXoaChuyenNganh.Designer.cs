...
namespace HoiNongDan.DataAccess.Migrations
{
    ...
    [Migration("20230812081043_EditCanBoXoaChuyenNganh")]
    partial class EditCanBoXoaChuyenNganh
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HoiNongDan.Models.CanBo", b =>
                {
                    ...
                    b.Property<DateTime?>("NgayThamGiaCapUyDang")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("NgayThamGiaCongTac")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("NgayThamGiaHDND")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("NgayVaoHoi")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<Guid?>("TrinhDoChuyenMonMaTrinhDoChuyenMon")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TrinhDoChuyenMonMaTrinhDoChuyenMon");
            ...
            modelBuilder.Entity("HoiNongDan.Models.CoSo", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 12, 15, 10, 41, 551, DateTimeKind.Local).AddTicks(1003));
            ...
            modelBuilder.Entity("HoiNongDan.Models.DiaBanHoatDong_ThanhVien", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("NgayRoiDi")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("NgayVao")
                        .HasColumnType("datetime2");

                    b.Property<bool>("RoiDi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.ToTable("DiaBanHoatDong_ThanhVien", "HV");
                });
            ...
            modelBuilder.Entity("HoiNongDan.Models.Entitys.TrinhDoChuyenMon", b =>
                {
                    b.Property<Guid>("MaTrinhDoChuyenMon")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HoiNongDan.Models.NgachLuong", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 12, 15, 10, 41, 551, DateTimeKind.Local).AddTicks(4737));
            ...
            modelBuilder.Entity("HoiNongDan.Models.CanBo", b =>
                {
                    ...
                    b.HasOne("HoiNongDan.Models.Entitys.TrinhDoChuyenMon", null)
                        .WithMany("CanBos")
                        .HasForeignKey("TrinhDoChuyenMonMaTrinhDoChuyenMon");
            ...
            modelBuilder.Entity("HoiNongDan.Models.DiaBanHoatDong_ThanhVien", b =>
                {
                    b.HasOne("HoiNongDan.Models.CanBo", "CanBo")
                        .WithMany("DiaBanHoatDongThanhViens")
                        .HasForeignKey("IDCanBo")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("FK_DiaBanHoatDong_ThanhVien_CanBo");

                    b.HasOne("HoiNongDan.Models.DiaBanHoatDong", "DiaBan")
                        .WithMany("DiaBanHoatDongThanhViens")
                        .HasForeignKey("IdDiaBan")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
            ...
            modelBuilder.Entity("HoiNongDan.Models.CanBo", b =>
                {
                    b.Navigation("DiaBanHoatDongThanhViens");
