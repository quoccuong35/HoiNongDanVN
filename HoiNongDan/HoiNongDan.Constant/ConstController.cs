namespace HoiNongDan.Constant
{
    public static class ConstController
    {
        ...
        public const string TrinhDoTinHoc = "TinHoc";
        public const string TrinhDoNgoaiNgu = "NgoaiNgu"; 
        public const string TrinhDoHocVan = "HocVan";
        public const string TrinhDoChinhTri = "ChinhTri";
